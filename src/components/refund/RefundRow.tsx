  ...
  return (
    ...
    >
        ...
        <div className="max-xl:absolute  flex overflow-hidden items-center justify-end xl:justify-center max-xl:mt-2 pl-px w-full min-h-[48px]">
          ...
          <Checkbox
            ...
            onCheckedChange={(checked) => {
              ...
              if (onCheckboxToggle) {
                onCheckboxToggle(refund.id, checked === true);
              }
            }}
          />
        </div>
      ...
      <div
        className={`flex flex-[3] flex-col  justify-center text-sm  text-neutral-800 `}
      >
        <div className="overflow-hidden self-stretch px-3 xl:px-2 py-4 w-full min-h-[48px] font-Averta-Regular xl:font-Averta-Semibold text-[14px]">
