    ...
    <>
      <div className="flex flex-col sm:flex-row h-fit sm:h-[80px] p-[10px] gap-[10px]">
        <div className="w-full sm:w-[20.5%] pl-[12px] sm:m-auto">
          <div className="text-[#202224] opacity-80 text-sm font-semibold">
            <span className="md:hidden text-base font-bold uppercase">
              service name:{" "}
            </span>
            {service_name}
          </div>
        ...
        <div className="w-full sm:w-[15.2%] pl-[12px] sm:m-auto py-[26.5] pr-[50px]">
          <div className="flex flex-row gap-4">
            <span className="md:hidden font-bold uppercase text-[#202224] opacity-80">
              status:{" "}
            </span>
            <div className={`${bgColor} h-[30px] rounded-lg w-fit px-3`}>
              <div
                className={`${textColor} text-xs font-bold flex items-center justify-center h-full`}
              >
                {status}
              </div>
            </div>
