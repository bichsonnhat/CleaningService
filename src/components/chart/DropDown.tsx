...
const Dropdown: React.FC<DropdownProps> = ({ setFilter }) => {
  ...
  return (
    <div className="relative">
      <button
        className="w-[104px] h-[38px] bg-[#fcfcfc] rounded-lg border border-neutral-300 flex items-center justify-between px-4 hover:bg-gray-400 duration-300"
      ...
      >
        ...
        <Image
          src="/images/Chart/drop_down.svg"
          alt="drop_down"
          width={10}
          height={10}
        />
