...
const EmployeeRow: React.FC<EmployeeRowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="lg:flex-[3] w-full lg:w-[200px] overflow-hidden flex items-center justify-start md:py-6 mb-2 md:mb-0">
      ...
      <div className="lg:flex-[5] w-full lg:w-[240px] overflow-hidden flex items-center justify-start md:py-6 mb-2 md:mb-0">
        <div className="text-sm text-[#202224] font-semibold">
      ...
      <div className="lg:flex-[4] w-full lg:w-[182px] overflow-hidden flex items-center justify-start md:pl-0 mb-2 md:mb-0">
      ...
      <div className="lg:flex-[3] w-full lg:w-[130px] overflow-hidden flex items-center justify-start md:py-6 mb-2 md:mb-0">
      ...
      <div className="lg:flex-[3] w-full lg:w-[180px] overflow-hidden flex items-center justify-start md:py-6 mb-2 md:mb-0">
      ...
      <div className="lg:flex-[3] w-full lg:w-[130px] overflow-hidden flex items-center lg:justify-center lg:py-6 mb-2 lg:mb-0">
        <div className=" flex flex-row items-center text-sm text-[#202224cc]">
