                ...
                <div className='font-bold text-3xl md:text-5xl w-full flex flex-col gap-5 mb-8 md:mb-0'>
                    ...
                    <div className='flex flex-col max-w-full md:max-w-[400px] gap-3 font-Averta-Regular'>
                        ...
                        <li className='flex gap-1.5'>
                            ...
                            <p className='text-[15px]'><span className='font-Averta-Bold'>Sparkling clean home:</span> Sit back and relax while professionals deep clean every nook and cranny, leaving your home spotless.</p>                   
                        </li>
                        <li className='flex gap-1.5'>
                            <Check className='h-5 w-5 shrink-0 text-blue-600 mt-2 md:mt-[-3px]'/>
                            <p className='text-[15px]'><span className='font-Averta-Bold'>More time for you:</span> Reclaim your weekends! Skip the scrubbing and spend your time on hobbies, family, and fun.</p>                   
                        </li>
                        <li className='flex gap-1.5'>
                            <Check className='h-5 w-5 shrink-0 text-blue-600 mt-2 md:mt-[-3px]'/>
                            <p className='text-[15px]'><span className='font-Averta-Bold'>Healthy living:</span> A professional clean reduces allergens and germs, creating a healthier environment for you and your loved ones.</p>                   
                        </li>
                    </div>
                    ...
                    <div className='flex flex-row items-start gap-5 mt-5'>
                        <div className='flex -space-x-4'>
                            {[1, 2, 3, 4, 5].map((num) => (
                                <Image 
                                    key={num}
                                    src={`/images/HomePage/users/user-${num}${num > 3 ? '.jpg' : '.png'}`} 
                                    alt='user image' 
                                    width={0} 
                                    height={0} 
                                    sizes="100vw" 
                        ...
                        <div className='flex flex-col justify-between items-start gap-2'>
                            ...
                            <div className='text-[15px] font-Averta-Regular'>
                                <p><span className='font-Averta-Bold'>1.250+</span> happy customers</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className='flex flex-col gap-5 p-4'>
                                    ...
                                    <div className='max-w-full md:max-w-[470px] text-black text-base md:text-lg leading-7 md:leading-8'>
                                        "{data.feedback.map((segment, segmentIndex) => (
                                            <span 
                                                key={segmentIndex}
                                                className={segment.isHighlighted ? 'p-0.5 bg-slate-800 text-white font-Averta-Regular' : ''}
                                            >
                                                {segment.text}
                                            </span>
                                        ))}"
