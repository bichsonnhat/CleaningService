...
const ServicePage = () => {
        ...
        return (
            <div className="grid grid-cols-7 gap-2 text-center">
                ...
                {prevMonthDays.map((day) => (
                    <div
                        key={`prev-${day}`}
                        className="w-[164px] h-[119px] border rounded-lg p-2 relative text-gray-400"
                    >
                ...
                {currentMonthDays.map((day) => {
                    ...
                    return (
                        <div
                            key={`current-${day}`}
                            className="w-[164px] h-[119px] border rounded-lg p-2 relative"
                        >
        ...
        return (
            <div>
                ...
                <div className="flex flex-row">
                    <div className="grid grid-cols-2 border-b gap-[30px]">
                ...
                <div className="border-t border-b">
                    {hours.map((hour) => (
                        <div
                            key={hour}
                            className="flex items-start h-[80px] border-b"
                        >
                                ...
                                {dayTasks.map((task, index) => {
                                    ...
                                    if (hour === startHour) {
                                        return (
                                            <div
                                                key={index}
                                                className="absolute bg-blue-100 text-blue-800 rounded-lg shadow-sm flex items-center"
                                                style={{
                                                    top: `${
                                                        (startMin / 60) * 80 + 5
                                                    }px`,
    ...
    return (
        <div className="w-[1207px] h-[970px] mx-auto p-4 bg-white shadow-md rounded-lg">
            <div className="flex justify-between items-center mb-4">
                ...
                {/* Center section with month or day title */}
